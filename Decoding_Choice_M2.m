...
load M2_A1_Data_100ms_Target
load M2_PFC_Data_100ms_Target
...
Acc_PFC=nan(size (M2_A1_Data_100ms_Target,2),size (M2_A1_Data_100ms_Target{1},2),4);
Acc_AC=nan(size (M2_A1_Data_100ms_Target,2),size (M2_A1_Data_100ms_Target{1},2)),4;

% for s= 11
parfor s=1: size (M2_A1_Data_100ms_Target,2)
    % for s= f

    size (M2_A1_Data_100ms_Target,2) - s

    An_AC_Sess    = M2_A1_Data_100ms_Target{s};
    An_PFC_Sess   = M2_PFC_Data_100ms_Target{s};
