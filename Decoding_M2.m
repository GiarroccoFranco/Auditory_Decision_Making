...
Acc_PFC=nan(size (M2_A1_Data_100ms,2),size (M2_A1_Data_100ms{1},2),4);
Acc_AC=nan(size (M2_A1_Data_100ms,2),size (M2_A1_Data_100ms{1},2)),4;

% for s= 11
parfor s=1: size (M2_A1_Data_100ms,2)
    % for s= f
